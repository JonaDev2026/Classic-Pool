...
SET_PALLE = (
    ...
    ("set_pastello", [(255, 212, 86), (88, 168, 255), (255, 108, 120),
...
SET_BLACKBALL = (
    ("set_classico", (200, 26, 34), (246, 202, 20), (16, 16, 18),
     (204, 46, 46)),
    ("set_pro", (160, 14, 28), (232, 180, 16), (10, 10, 12), None),
...
SET_BIRILLI = (
    ...
    ("set_perla", (244, 238, 222), (214, 178, 80), (128, 24, 40),
     (160, 120, 60)),
    ("set_pastello", (255, 255, 255), (255, 214, 90), (255, 108, 120),
     (255, 120, 180)),
    ("set_neon", (250, 250, 250), (255, 232, 0), (255, 30, 80),
     (0, 200, 255)),
    ("set_notte", (236, 240, 248), (60, 150, 255), (255, 170, 0),
     (20, 20, 30)),
)
...
def _tessitura(num, font, asset=None):
    ...
    if tipo_palle() == "snooker":
        ...
        if 1 <= num <= 15:
            ...
            st = set_blackball()
            s.fill(st[1] if num <= 7 else st[3] if num == 8 else st[2])
            return pygame.surfarray.array3d(s).astype(np.float32)
...
def schermata_menu(sc, clock, logo):
    ...
    def voci_ora():
        if categoria is None:
            return [nome_categoria(i) for i in range(len(CATEGORIE))] + [T("rules"), T("settings"),
                                                T("quit")]
    ...
    def scelta(i):
        ...
        if categoria is None:
            if i < len(CATEGORIE):
                categoria, sel = i, 0
                return None
            return ("regole", "settings", "quit")[i - len(CATEGORIE)]
...
def _gioca(sc, clock, logo, cpu=None, torneo=False, panno=None, bordo=None,
    ...
    while True:
        ...
        if partita.finita:
            box = pygame.Surface((s(520), s(110)), pygame.SRCALPHA)
            box.fill((10, 10, 14, 225))
            sc.blit(box, box.get_rect(center=(WIN_W // 2, WIN_H // 2)))
