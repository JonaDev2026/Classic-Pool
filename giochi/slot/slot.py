...
SIMBOLI = (
    ("ciliegia",     (226,  80, 110), "C", 10,  15,  52,  190),
    ("limone",       (232, 224,  90), "L", 10,  15,  52,  190),
    ("arancia",      (240, 150,  60), "O", 10,  17,  58,  210),
    ("prugna",       (150, 110, 200), "P", 10,  17,  58,  210),
    ("mela",         (120, 200, 100), "M", 10,  17,  58,  210),
    ("fragola",      (232,  90, 100), "F", 10,  19,  64,  235),
    ("anguria",      (236, 120, 150), "A",  0,  19,  64,  235),
    ("uva",          (150, 110, 190), "U",  0,  19,  64,  235),
    ("cuori",        (230,  70,  90), "H",  0,  21,  72,  265),
    ("picche",       (150, 110, 230), "S",  0,  24,  80,  300),
    ("fiori",        ( 80, 120, 220), "K",  0,  24,  80,  300),
    ("quadri",       (226,  50,  90), "D",  0,  24,  80,  300),
    ("campana",      (240, 190,  70), "B",  0,  30, 105,  400),
    ("ferro",        (200, 205, 215), "V",  0,  30, 105,  400),
    ("quadrifoglio", ( 90, 200, 110), "Q",  0,  30, 105,  400),
    ("carte",        (240, 240, 245), "T",  0,  42, 145,  545),
    ("roulette",     ( 90, 170, 190), "R",  0,  42, 145,  545),
    ("fiches",       (220, 100, 130), "G",  0,  42, 145,  545),
    ("dollaro",      (240, 190,  70), "$", 25,  60, 215,  825),
    ("gemma",        (140, 210, 240), "^", 25,  60, 215,  825),
    ("bar",          ( 60, 180, 220), "=", 25,  60, 215,  825),
    ("sette",        (226,  60,  60), "7", 30, 105, 365, 1400),
