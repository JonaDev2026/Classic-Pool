...
SIMBOLI = (
    ("ciliegia",     (226,  80, 110), "C",  10,  18,  58,  245),
    ("limone",       (232, 224,  90), "L",  10,  18,  58,  245),
    ("arancia",      (240, 150,  60), "O",  10,  18,  58,  245),
    ("prugna",       (150, 110, 200), "P",  10,  18,  58,  245),
    ("mela",         (120, 200, 100), "M",  10,  18,  58,  245),
    ("fragola",      (232,  90, 100), "F",  10,  18,  58,  245),
    ("anguria",      (236, 120, 150), "A",  10,  22,  72,  300),
    ("uva",          (150, 110, 190), "U",  10,  22,  72,  300),
    ("cuori",        (230,  70,  90), "H",   0,   9,  32,  125),
    ("picche",       (150, 110, 230), "S",   0,   9,  32,  125),
    ("fiori",        ( 80, 120, 220), "K",   0,   9,  32,  125),
    ("quadri",       (226,  50,  90), "D",   0,   9,  32,  125),
    ("campana",      (240, 190,  70), "B",   0,  30, 105,  425),
    ("ferro",        (200, 205, 215), "V",   0,  30, 105,  425),
    ("quadrifoglio", ( 90, 200, 110), "Q",   0,  30, 105,  425),
    ("carte",        (240, 240, 245), "T",   0,  48, 170,  700),
    ("roulette",     ( 90, 170, 190), "R",   0,  48, 170,  700),
    ("fiches",       (220, 100, 130), "G",   0,  48, 170,  700),
    ("dollaro",      (240, 190,  70), "$",   0,  80, 290, 1180),
    ("gemma",        (140, 210, 240), "^",   0,  80, 290, 1180),
    ("bar",          ( 60, 180, 220), "=",   0,  80, 290, 1180),
    ("sette",        (226,  60,  60), "7",   0, 160, 560, 2300),
...
PUNTATE = (50, 100, 250, 500, 1000)   # quanto si gioca a giro
