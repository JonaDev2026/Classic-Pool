...
SIMBOLI = (
    ("ciliegia",     (226,  80, 110), "C",  0,  18,  60,  260),
    ("limone",       (232, 224,  90), "L",  0,  18,  60,  260),
    ("arancia",      (240, 150,  60), "O",  0,  20,  68,  290),
    ("prugna",       (150, 110, 200), "P",  0,  20,  68,  290),
    ("mela",         (120, 200, 100), "M",  0,  20,  68,  290),
    ("fragola",      (232,  90, 100), "F",  0,  22,  76,  320),
    ("anguria",      (236, 120, 150), "A",  0,  22,  76,  320),
    ("uva",          (150, 110, 190), "U",  0,  22,  76,  320),
    ("cuori",        (230,  70,  90), "H",  0,  26,  88,  360),
    ("picche",       (150, 110, 230), "S",  0,  29, 100,  420),
    ("fiori",        ( 80, 120, 220), "K",  0,  29, 100,  420),
    ("quadri",       (226,  50,  90), "D",  0,  29, 100,  420),
    ("campana",      (240, 190,  70), "B",  0,  38, 132,  545),
    ("ferro",        (200, 205, 215), "V",  0,  38, 132,  545),
    ("quadrifoglio", ( 90, 200, 110), "Q",  0,  38, 132,  545),
    ("carte",        (240, 240, 245), "T",  0,  53, 184,  760),
    ("roulette",     ( 90, 170, 190), "R",  0,  53, 184,  760),
    ("fiches",       (220, 100, 130), "G",  0,  53, 184,  760),
    ("dollaro",      (240, 190,  70), "$", 30,  76, 264, 1120),
    ("gemma",        (140, 210, 240), "^", 30,  76, 264, 1120),
    ("bar",          ( 60, 180, 220), "=", 30,  76, 264, 1120),
    ("sette",        (226,  60,  60), "7", 40, 128, 448, 2000),
